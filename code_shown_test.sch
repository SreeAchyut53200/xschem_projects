...
F {}
E {}
B 2 -150 -1790 650 -1390 {flags=graph
y1=0
y2=2
ypos1=0.2
ypos2=2.2
...
en
clk
DATA;bl3,bl2,bl1,bl0"
color="4 5 6 7 8 9 10 11 12 4"
dataset=-1
unitx=1
logx=0
logy=0
...
"}
C {code.sym} -1070 -880 0 0 {name=all_thresholds only_toplevel=false spice_ignore=true value=
"
...
device=resistor
m=1}
C {code_shown.sym} -1390 -1360 0 0 {name=s3 only_toplevel=false spice_ignore=true value=
"
...
.endc
"}
C {code_shown.sym} -480 -1480 0 0 {name=s2 only_toplevel=false spice_ignore=false value=
"
.param VCC=1.8 VSS=0
...
V_VSS VSS 0 DC 0
"}
C {code_shown.sym} -480 -1340 0 0 {name=s5 only_toplevel=false value=
"
...
"}
C {launcher.sym} -90 -1810 0 0 {name=h5
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/code_shown_test.raw tran"
}
