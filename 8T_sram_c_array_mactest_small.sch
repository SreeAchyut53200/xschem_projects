...
N 270 220 640 220 {lab=#net1}
N 270 400 640 400 {lab=#net2}
C {8T_sram_cell_c.sym} 420 180 0 1 {name=x1}
...
C {lab_pin.sym} 760 220 0 1 {name=p8 sig_type=std_logic lab=RWL}
C {lab_pin.sym} 270 200 0 0 {name=p9 sig_type=std_logic lab=RBL}
C {sky130_fd_pr/cap_mim_m3_1.sym} 120 260 0 0 {name=C2 model=cap_mim_m3_1 W=250 L=1 MF=1 spiceprefix=X}
C {lab_pin.sym} 50 110 0 0 {name=p1 sig_type=std_logic lab=PRE}
C {gnd.sym} 120 60 2 0 {name=l1 lab=GND}
C {8T_sram_cell_c.sym} 420 360 0 1 {name=x2}
...
C {lab_pin.sym} 760 400 0 1 {name=p13 sig_type=std_logic lab=RWL}
...
V_PRE PRE 0 PULSE(\{VSS\} \{VCC\} \{dly + BL_period/2\} \{raise\} \{fall\} \{pre_time\} \{BL_period\} \{prds*2\})
...
C {sky130_fd_pr/nfet_01v8.sym} 100 110 2 1 {name=M2
W=1
L=0.15
nf=1 
mult=1
...
C {inv.sym} 700 220 0 1 {name=x3}
C {inv.sym} 700 400 0 1 {name=x4}
C {lab_pin.sym} 700 200 0 0 {name=p2 sig_type=std_logic lab=VCC}
C {lab_pin.sym} 700 380 0 0 {name=p15 sig_type=std_logic lab=VCC}
C {gnd.sym} 700 420 0 0 {name=l3 lab=GND}
C {gnd.sym} 700 240 0 0 {name=l5 lab=GND}
