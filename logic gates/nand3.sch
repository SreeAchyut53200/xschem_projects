...
N 40 90 40 200 {lab=VSS}
N 30 200 40 200 {lab=VSS}
...
N -170 -170 -70 -170 {lab=VCC}
N -170 -140 -160 -140 {lab=VCC}
N -160 -170 -160 -140 {lab=VCC}
N 30 40 30 60 {lab=#net2}
N 40 10 40 120 {lab=VSS}
N 30 90 40 90 {lab=VSS}
N -210 170 -10 170 {lab=C}
N -210 -140 -210 170 {lab=C}
N -170 -110 -70 -110 {lab=Y}
N -70 -110 30 -110 {lab=Y}
C {sky130_fd_pr/nfet_01v8.sym} 10 170 0 0 {name=M2
L=0.15
W=1  
nf=1 mult=1
model=nfet_01v8
...
C {iopin.sym} 30 250 0 1 {name=p2 lab=VSS}
...
C {sky130_fd_pr/pfet_01v8.sym} -190 -140 0 0 {name=M4
L=0.15
W=1
nf=1 mult=1
model=pfet_01v8
...
C {sky130_fd_pr/nfet_01v8.sym} 10 90 0 0 {name=M5
L=0.15
W=1  
nf=1 mult=1
model=nfet_01v8
...
C {iopin.sym} -10 170 0 1 {name=p1 lab=C}
