...
C {8T_sram_cell_c.sym} 420 540 0 1 {name=x3}
...
C {8T_sram_cell_c.sym} 420 720 0 1 {name=x4}
...
C {8T_sram_cell_c.sym} 420 900 0 1 {name=x5}
...
C {8T_sram_cell_c.sym} 420 1080 0 1 {name=x6}
...
C {8T_sram_cell_c.sym} 420 1260 0 1 {name=x7}
...
C {8T_sram_cell_c.sym} 420 1440 0 1 {name=x8}
...
C {code_shown.sym} -1190 30 0 0 {name=s2 only_toplevel=true value=
"
...
V_RWL RWL 0 PULSE(\{VCC\} \{VSS\} \{dly + BL_period/2 + 6ns\} \{raise\} \{fall\} \{read_time\} \{BL_period\} \{prds*2\})
...
C {code_shown.sym} -1190 -110 0 0 {name=s1 only_toplevel=false value=
"
.param VCC=1.8 VSS=0
