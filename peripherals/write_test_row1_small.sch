...
F {}
E {}
B 2 -1760 -2930 -960 -2530 {flags=graph
y1=-0.027
y2=1.9
ypos1=-0.4124
ypos2=1.5146
...
digital=1
hilight_wave=-1
color="19 5 6 7 8 9 10 11 12"
node="data;x1.q,x2.q,x3.q,x4.q,x5.q,x6.q,x7.q,x8.q
...
x2.q
x1.q"}
N 370 -1440 370 -1350 {lab=RBL7}
N 370 -1380 440 -1380 {lab=RBL7}
N 370 -1520 370 -1500 {lab=GND}
N 370 -1470 380 -1470 {lab=GND}
N 380 -1510 380 -1470 {lab=GND}
N 370 -1510 380 -1510 {lab=GND}
N 310 -1470 330 -1470 {lab=PRE}
N 280 -2250 2550 -2250 {lab=BL[0..7]
bus=true}
N 280 -2200 2550 -2200 {lab=BLB[0..7]
bus=true}
N 310 -2190 310 -2080 {lab=BLB0}
N 310 -2080 370 -2080 {lab=BLB0}
N 290 -2240 290 -2060 {lab=BL0
bus}
N 290 -2060 370 -2060 {lab=BL0}
N 600 -2190 600 -2080 {lab=BLB1}
N 600 -2080 660 -2080 {lab=BLB1}
N 580 -2240 580 -2060 {lab=BL1}
N 580 -2060 660 -2060 {lab=BL1}
N 890 -2190 890 -2080 {lab=BLB2}
N 890 -2080 950 -2080 {lab=BLB2}
N 870 -2240 870 -2060 {lab=BL2}
N 870 -2060 950 -2060 {lab=BL2}
N 1180 -2190 1180 -2080 {lab=BLB3}
...
C {lab_pin.sym} 370 -2100 0 0 {name=p1 sig_type=std_logic lab=WL0}
...
C {code_shown.sym} -1140 -1780 0 0 {name=s2 only_toplevel=false spice_ignore=false value=
"
.param VCC=1.8 VSS=0
...
C {code_shown.sym} -500 -1580 0 1 {name=s3 only_toplevel=false spice_ignore=true value=
"
...
C {sky130_fd_pr/cap_mim_m3_1.sym} 370 -1320 0 0 {name=C2 model=cap_mim_m3_1 W=25 L=1 MF=1 spiceprefix=X}
C {gnd.sym} 370 -1520 2 0 {name=l1 lab=GND}
C {sky130_fd_pr/nfet_01v8.sym} 350 -1470 2 1 {name=M2
W=1
L=0.15
nf=1 
mult=1
...
C {gnd.sym} 370 -1290 0 1 {name=l10 lab=GND}
C {iopin.sym} 110 -1840 0 0 {name=p93 lab=PRE}
C {lab_pin.sym} 110 -1840 0 0 {name=p95 sig_type=std_logic lab=PRE}
C {lab_pin.sym} 310 -1470 0 0 {name=p96 sig_type=std_logic lab=PRE}
C {lab_pin.sym} 660 -2100 0 0 {name=p2 sig_type=std_logic lab=WL0}
C {lab_pin.sym} 660 -2000 0 0 {name=p5 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 660 -2120 0 0 {name=p6 sig_type=std_logic lab=VCC}
C {8T_sram_cell_c.sym} 520 -2060 0 1 {name=x1}
C {lab_pin.sym} 660 -2020 0 0 {name=p15 sig_type=std_logic lab=RWL}
C {lab_pin.sym} 660 -2040 0 0 {name=p16 sig_type=std_logic lab=RBL7}
C {lab_pin.sym} 950 -2100 0 0 {name=p28 sig_type=std_logic lab=WL0}
C {lab_pin.sym} 950 -2000 0 0 {name=p31 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 950 -2120 0 0 {name=p32 sig_type=std_logic lab=VCC}
C {8T_sram_cell_c.sym} 810 -2060 0 1 {name=x2}
C {lab_pin.sym} 950 -2020 0 0 {name=p33 sig_type=std_logic lab=RWL}
C {lab_pin.sym} 950 -2040 0 0 {name=p34 sig_type=std_logic lab=RBL7}
C {lab_pin.sym} 1240 -2100 0 0 {name=p36 sig_type=std_logic lab=WL0}
C {lab_pin.sym} 1240 -2000 0 0 {name=p39 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 1240 -2120 0 0 {name=p40 sig_type=std_logic lab=VCC}
...
C {bus_tap.sym} 280 -2250 1 0 {name=l2 lab=0}
C {lab_pin.sym} 280 -2250 0 0 {name=p3 sig_type=std_logic lab=BL[0..7]}
C {lab_pin.sym} 280 -2200 0 0 {name=p4 sig_type=std_logic lab=BLB[0..7]}
C {bus_tap.sym} 300 -2200 1 0 {name=l3 lab=0}
C {bus_tap.sym} 570 -2250 1 0 {name=l4 lab=1}
C {bus_tap.sym} 590 -2200 1 0 {name=l5 lab=1}
C {bus_tap.sym} 860 -2250 1 0 {name=l6 lab=2}
...
C {lab_pin.sym} 440 -1380 0 1 {name=p50 sig_type=std_logic lab=RBL7}
